...
def main():
    ...
    ap.add_argument("--fontsize", type=int, default=0, help="字幕字号(0=按分辨率自适应)")
    args = ap.parse_args()
    ...
    # —— 3. 字幕样式：竖屏大字号，白字黑描边，底部居中 ——
    fs = args.fontsize or max(28, int((vh or 720) * 0.05))
    style = (f"FontName=Microsoft YaHei,FontSize={fs},"
             f"PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,"
             f"Outline=3,Bold=1,Alignment=2,MarginV=40")
